        ...
        >
          <div className="card">
            <div className="text-center mb-8">
              <div className="w-16 h-16 rounded-full bg-primary/20 border-4 border-primary/30 text-primary text-2xl font-bold flex items-center justify-center mx-auto mb-4">
                ✉
              </div>
